let mostrador2 = document.getElementById("mostrador");
let seleccion2 = document.getElementById("seleccion");
let imgSeleccionada2 = document.getElementById("img");
let modeloSeleccionado2 = document.getElementById("modelo");
let descripSeleccionada2 = document.getElementById("detalle2");
let precioSeleccionado2 = document.getElementById("precio");
let nombreProducto2 = document.getElementById("nombreproducto2");
let categoria2 = document.getElementById("categoria");
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          if (response.data.getProductos.length > 0) {
            // Filtrar productos solo para la categoría "Equipos"
            let productosEquipos = response.data.getProductos.filter(producto => producto.categoria === 'Equipos' && !prestamosActivos.includes(producto.id));
            // Iteración sobre los productos filtrados
            productosEquipos.forEach((producto, index) => {
...
var idProducto2;
var ProductoDetalle2;
var NombreProducto2;

function cargar(item, producto) {
  console.log("Cargo:");
  idProducto2 = producto.id;
  ProductoDetalle2 = producto.detalle;
  console.log(ProductoDetalle2);
  NombreProducto2 = producto.nombreproducto;
  ...
  imgSeleccionada2.src = item.getElementsByTagName("img")[0].src;
  descripSeleccionada2.innerHTML = ProductoDetalle2;
  ...
  nombreProducto2.innerHTML = NombreProducto2;
